...
void SBomber::ProcessKBHit() { Pimpl->ProcessKBHit(); }
void SBomber::TimeStart() { Pimpl->TimeStart(); }
void SBomber::TimeFinish() { Pimpl->TimeFinish(); }
void SBomber::DrawFrame() { Pimpl->DrawFrame(); }
void SBomber::MoveObjects() { Pimpl->MoveObjects(); }
void SBomber::CheckObjects() { Pimpl->CheckObjects(); }
